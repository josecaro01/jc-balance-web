                            ...
                            <td colSpan={5} className="p-5">
                                <div className="flex flex-col items-center justify-center h-full space-y-4">
                                    <div className="relative">
                                        <div className="absolute -inset-1 bg-linear-to-r from-primary/20 to-blue-500/20 blur rounded-full"></div>
                                        <div className="relative bg-card p-4 rounded-full border border-border shadow-sm">
                                            <EditIcon className="w-8 h-8 text-slate-300" />
                                        </div>
                                    </div>
                                    <div className="text-center">
                                        <p className="text-lg font-bold text-page-text">
                                            {t('noResults')}
                                        </p>
                                        <p className="text-sm text-slate-500 max-w-62.5 mx-auto">
                                            {t('noResultsDesc')}
                                        </p>
                                    </div>
                                </div>
